...
const healthPrograms = [
  { id: "1", title: "TB Prevention and Treatment", diseaseType: "tb", description: "Comprehensive TB prevention, testing, and treatment program" },
  { id: "2", title: "Malaria-Free Communities", diseaseType: "malaria", description: "Malaria prevention and treatment for high-risk communities" },
  { id: "3", title: "HIV Testing and Counseling", diseaseType: "hiv", description: "Confidential HIV testing, counseling, and treatment support" },
  { id: "4", title: "Maternal TB Screening", diseaseType: "tb", description: "TB screening and prevention for pregnant women" },
  { id: "5", title: "Youth HIV Awareness", diseaseType: "hiv", description: "HIV education and prevention program for youth" },
];
                    ...
                    <FormControl>
                      <RadioGroup onValueChange={field.onChange} defaultValue={field.value}>
                        <div className="flex gap-4">
                          <FormItem><FormControl><RadioGroupItem value="male" />Male</FormControl></FormItem>
                          <FormItem><FormControl><RadioGroupItem value="female" />Female</FormControl></FormItem>
                          <FormItem><FormControl><RadioGroupItem value="other" />Other</FormControl></FormItem>
                        </div>
                      </RadioGroup>
                    </FormControl>
                    <FormMessage />
                        ...
                        <CommandList>
                          ...
                          <CommandGroup>
                            {healthPrograms.map((program) => (
                              ...
                              >
                                <Check className={cn("mr-2 h-4 w-4", selectedPrograms.includes(program.id) ? "opacity-100" : "opacity-0")} />
                                {program.title}
                              </CommandItem>
                            ))}
                          </CommandGroup>
